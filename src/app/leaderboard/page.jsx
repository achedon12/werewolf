...
const PodiumPage = () => {
    ...
    if (loading) {
        return (
            <div
                className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-purple-900 dark:to-slate-900 flex items-center justify-center p-4">
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-purple-900 dark:to-slate-900 py-4 md:py-8">
            <style jsx>{`
                @keyframes float {
                    0%, 100% {
            ...
            <div className="container mx-auto px-3 md:px-4">
                <div className="text-center mb-8 md:mb-12">
                    <div className="flex justify-center items-center gap-2 md:gap-4 mb-4 md:mb-6">
                        <div
                            className="p-2 md:p-4 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-xl md:rounded-2xl shadow-lg">
                        ...
                        <div
                            className="p-2 md:p-4 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-xl md:rounded-2xl shadow-lg">
                                ...
                                >
                                    <div
                                        ...
                                        {index === 1 && !isMobile && (
                                            <>
                                                <div
                                                    className="absolute top-1 md:top-2 right-1 md:right-2 w-2 h-2 md:w-3 md:h-3 bg-yellow-300 rounded-full animate-ping"></div>
                                                <div
                                                    className="absolute top-4 md:top-8 left-2 md:left-3 w-1 h-1 md:w-2 md:h-2 bg-yellow-200 rounded-full animate-pulse"></div>
                                            </>
                                        )}

                                        <div className="text-center relative z-10">
                                            <div
                                                className="flex items-center justify-center gap-1 md:gap-2 mb-2 md:mb-4">
                                                <IconComponent className={`${position.iconSize} ${position.text}`}/>
                                            ...
                                            <div className="flex justify-center mb-2 md:mb-4">
                                                <div
                                                    className={`relative ${position.avatarSize} rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center overflow-hidden shadow-lg border-2 ${
                                                    ...
                                                    {index === 1 && !isMobile && (
                                                        <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2">
                                                            <Crown
                                                                className="h-3 w-3 md:h-5 md:w-5 lg:h-6 lg:w-6 text-yellow-300 animate-bounce"/>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-2 gap-1 md:gap-2 text-xs">
                                                <div className="bg-black/20 rounded p-1 md:p-2">
                                                    <div
                                                        className="font-bold text-sm md:text-lg">{player.victories}</div>
                                                    <div className="text-white/70 text-[10px] md:text-xs">Victoires
                                                    </div>
                                                </div>
                                                <div className="bg-black/20 rounded p-1 md:p-2">
                                                    <div
                                                        className="font-bold text-sm md:text-lg">{calculateWinRate(player)}%
                                                    </div>
                                                    <div className="text-white/70 text-[10px] md:text-xs">Win Rate</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        className={`w-4/5 ${position.height} bg-gradient-to-b ${position.gradient} rounded-b-lg md:rounded-b-xl relative mt-1 md:mt-2 shadow-lg`}>
                                        <div
                                            className="absolute inset-0 bg-gradient-to-t from-white/20 to-transparent rounded-b-lg md:rounded-b-xl"></div>
                                        <div
                ...
                <div className="max-w-4xl mx-auto mb-8 md:mb-12">
                    <div
                        className="bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-gray-200 dark:border-gray-700">
                        <div className="p-4 md:p-6">
                            ...
                            <div className="space-y-2 md:space-y-3">
                                {leaderboard.slice(3).map((player, index) => (
                                    ...
                                    >
                                        <div
                                            className="flex items-center justify-center w-6 h-6 md:w-8 md:h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex-shrink-0">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div
                                                className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center overflow-hidden border border-white dark:border-gray-600 shadow-md">
                                                {player.avatar ? (
                                                    <img
                                                        src={player.avatar}
                                                        alt={player.nickname}
                                                    ...
                                                    <Users
                                                        className="h-3 w-3 md:h-4 md:w-4 lg:h-6 lg:w-6 text-white/80"/>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-2 md:gap-4 lg:gap-6 text-right">
                                            <div className="text-center">
                                                <div
                                                    className="text-gray-900 dark:text-white font-bold text-sm md:text-lg">
                                                    {player.victories}
                                                </div>
                                                <div
                                                    className="text-gray-500 dark:text-gray-400 text-[10px] md:text-xs">Victoires
                                                </div>
                                            </div>
                                            <div className="text-center">
                                                <div
                                                    className="text-green-600 dark:text-green-400 font-bold text-sm md:text-lg">
                                                    {calculateWinRate(player)}%
                                                </div>
                                                <div
                                                    className="text-gray-500 dark:text-gray-400 text-[10px] md:text-xs">Win
                                                    Rate
                                                </div>
                                            </div>
                                            {!isMobile && (
                                                <div className="text-center">
                                                    ...
                                                    <div className="text-gray-500 dark:text-gray-400 text-xs">Parties
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                            ...
                            {leaderboard.length === 0 && (
                                <div className="text-center py-6 md:py-12">
                                    <Target className="h-8 w-8 md:h-12 md:w-12 text-gray-400 mx-auto mb-2 md:mb-4"/>
                ...
                {leaderboard.length > 0 && (
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
                            <div
                                className="bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl p-3 md:p-6 text-center border border-gray-200 dark:border-gray-700 shadow-lg transition-shadow">
                                <div
                                    className="p-2 md:p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-xl md:rounded-2xl w-10 h-10 md:w-12 md:h-12 mx-auto mb-2 md:mb-4 flex items-center justify-center">
                                    <Award className="h-4 w-4 md:h-6 md:w-6 text-yellow-600 dark:text-yellow-400"/>
                                </div>
                                <div
                                    className="text-xl md:text-3xl font-bold text-yellow-600 dark:text-yellow-400 mb-1 md:mb-2">
                                    {leaderboard[0]?.victories || 0}
                                </div>
                                <div
                                    className="text-gray-600 dark:text-gray-300 font-medium text-xs md:text-sm mb-1">Record
                                    de victoires
                                </div>
                            ...
                            <div
                                className="bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl p-3 md:p-6 text-center border border-gray-200 dark:border-gray-700 shadow-lg transition-shadow">
                                <div
                                    className="p-2 md:p-3 bg-green-100 dark:bg-green-900/30 rounded-xl md:rounded-2xl w-10 h-10 md:w-12 md:h-12 mx-auto mb-2 md:mb-4 flex items-center justify-center">
                                    <TrendingUp className="h-4 w-4 md:h-6 md:w-6 text-green-600 dark:text-green-400"/>
                                </div>
                                <div
                                    className="text-xl md:text-3xl font-bold text-green-600 dark:text-green-400 mb-1 md:mb-2">
                                ...
                                <div
                                    className="text-gray-600 dark:text-gray-300 font-medium text-xs md:text-sm">Meilleur
                                    win rate
                                </div>
                            </div>
                            ...
                            <div
                                className="bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl p-3 md:p-6 text-center border border-gray-200 dark:border-gray-700 shadow-lg transition-shadow">
                                <div
                                    className="p-2 md:p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl md:rounded-2xl w-10 h-10 md:w-12 md:h-12 mx-auto mb-2 md:mb-4 flex items-center justify-center">
                                    <Users className="h-4 w-4 md:h-6 md:w-6 text-blue-600 dark:text-blue-400"/>
                                </div>
                                <div
                                    className="text-xl md:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1 md:mb-2">
                                    {leaderboard.reduce((total, player) => total + player.games, 0)}
                                </div>
                                <div className="text-gray-600 dark:text-gray-300 font-medium text-xs md:text-sm">Parties
                                    totales
                                </div>
                            </div>
                        </div>
